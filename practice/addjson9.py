# TODO edit the save-data and load_data functions to save and load data as json
from functools import reduce 
import hashlib as hl
from collections import OrderedDict

from hash_utils_practice import hash_string_256, hash_block
...
def load_data():
    # TODO: Use a Try -Except with IOError 
    with open("blockchain.txt", mode="r") as f:
        content = f.readlines()
        global blockchain
        global open_transactions
        blockchain = content[0]
        open_transactions = content[1]
